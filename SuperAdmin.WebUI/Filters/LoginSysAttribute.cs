...
namespace SuperAdmin.WebUI.Filters
{
    [AttributeUsage(AttributeTargets.Class | AttributeTargets.Method, AllowMultiple = false, Inherited = true)]
    public class LoginSysAttribute : ActionFilterAttribute
    {
        public override void OnActionExecuted(ActionExecutedContext ctx)
        {
            ...
            if (ctx.HttpContext.Session[AppContext.SESSION_LOGIN_NAME] == null)
            {
            ...
            if (ctx.HttpContext.Session[AppContext.SESSION_LOGIN_NAME] != null)
            {
                ...
                SessionLoginModel model = ctx.HttpContext.Session[AppContext.SESSION_LOGIN_NAME] as SessionLoginModel;
