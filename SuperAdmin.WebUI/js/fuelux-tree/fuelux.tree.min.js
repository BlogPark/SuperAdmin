            ...
            function (g) {
                ...
                function (h, j) {
                    ...
                    if (j.type === "folder") {
                        ...
                        i.find(".tree-folder-name").attr("value", j.id);
                        ...
                        if (j.type === "item") {
                            ...
                            i.find("i").attr("value", j.id);
                            i.data(j);
                            if ("additionalParameters" in j && "item-selected" in j.additionalParameters && (j.additionalParameters["item-selected"] == true || j.additionalParameters["item-selected"] == "true")) {
